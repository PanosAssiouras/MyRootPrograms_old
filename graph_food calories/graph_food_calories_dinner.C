...
void graph_food_calories_dinner()
{
  ...
  vector<double_t> intake_cals, cals_suggested;
   ...
   TH1F *h1= new TH1F("h1exp","#splitline{Calories intake and calories suggested}{Daily diner} ",32,0,32);
      TH1F *h2= new TH1F("h2exp","Capacitance theretical vs Capacitance experimental stripbystrip",32,0,32);
