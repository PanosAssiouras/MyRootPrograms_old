...
void graph_food_calories()
{
  ...
  vector<double_t> intake_cals, cals_suggested;
   ...
   TH1F *h1= new TH1F("h1exp","#splitline{Calories intake and calories suggested}{Daily beakfast} ",26,0,26);
      TH1F *h2= new TH1F("h2exp","Capacitance theretical vs Capacitance experimental stripbystrip",26,0,26);
