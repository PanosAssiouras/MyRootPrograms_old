...
int MaPsa_IV_v5()
{
  ...
  //  c0->Divide(2,3);
    ...
    TCanvas *c1=new TCanvas("c1","Total current:std_2_15_351136",300,10,900,500);
    c1->SetGrid();

    TCanvas *c3=new TCanvas("c3","Current matrix 200V:std_2_15_351136",300,10,900,500);
    c3->SetGrid();

     TCanvas *c5=new TCanvas("c5","Current matrix 200V:std_2_15_351136",300,10,900,500);
     c5->SetGrid();
   ...
   TH2D *Hist= new TH2D("Hist","2D",48,0,48,6,0,6);
    ...
    TMultiGraph *mg = new TMultiGraph();
     mg->SetMinimum(-10.0);
     mg->SetMaximum(100.0);
     mg->SetTitle("Current vs Voltage:0 to 350:std_2_15_351136");
...
*/
    ...
    Xaxis->SetNdivisions(127,kTRUE);
    Yaxis->SetNdivisions(0,kTRUE);
