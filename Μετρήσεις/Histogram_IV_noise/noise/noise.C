...
{   
    ...
    TCanvas *c0=new TCanvas("c0","noise:0 to -350V",300,10,900,500);
    c0->SetGrid();
    
    TCanvas *c1=new TCanvas("c1","Histogram:noise",300,10,900,500);
    c1->SetGrid();
    
    TCanvas *c2=new TCanvas("c2","Histogram:noise",300,10,900,500);
    c1->SetGrid();
 
 
    TGraph *gr= new TGraph();
    TH1F *Hist= new TH1F("Hist","",30,-150,150);
    ...
    c1->cd();
     ...
     c2->cd();
     Hist1->SetTitle("Histogram:noise:");
     Hist1->Fit("gaus");   
