...
void readwitharrays_backplane_120()
         ...
         std::ifstream inputFile9("Region_9/backplane.txt");
          std::ifstream inputFile10("Region_10/backplane.txt");
           std::ifstream inputFile11("Region_11/backplane.txt");
            ...
            std::ofstream myfile;
            myfile.open ("Backplane.Capacitance.allRegions.120.experimental.txt");
 ...
 //Region_5.txt 
   ...
   //  double Voltage = 0., Backplane= 0., Strip=0. , StripAll=0.;
     ...
     points++;
      ...
      gr5->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
...
//----------------------------------------------------------------------------------------------------------------    
   ...
   //  double Voltage = 0., Backplane= 0., Strip=0. , StripAll=0.;
     ...
     points++;
      ...
      gr6->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
...
//----------------------------------------------------------------------------------------------------------------  
   ...
   //  double Voltage = 0., Backplane= 0., Strip=0. , StripAll=0.;
     ...
     points++;
      ...
      gr7->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
...
//----------------------------------------------------------------------------------------------------------------  
  ...
  /
      gr8->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
...
//----------------------------------------------------------------------------------------------------------------  
   ...
   //  double Voltage = 0., Backplane= 0., Strip=0. , StripAll=0.;
     ...
     points++;
      ...
      gr9->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
...
//----------------------------------------------------------------------------------------------------------------  
   ...
   //  double Voltage = 0., Backplane= 0., Strip=0. , StripAll=0.;
     ...
     points++;
      ...
      gr10->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
...
//----------------------------------------------------------------------------------------------------------------  
   ...
   while(getline(inputFile12, line)) {
     ...
     points++;
      ...
      gr12->SetPoint(points-1,abs(Voltage),Backplane_Capacitance);
   }
