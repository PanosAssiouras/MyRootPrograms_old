...
void hpk_measurements_pstop_21_gr()
{  
   ...
   std::vector<float_t> Voltages,Circular_Diode,Diode,Half_diode,Quarter_Diode;
    ...
    TCanvas *c1=new TCanvas("c1","CV_tests_with_GR/P_stop/Serial_Nb_21",300,10,900,500);
    c1->Divide(2,2,0.0001,0.0001);
    c1->SetGrid();
    TCanvas *c0=new TCanvas("c0","CV_tests_with_GR/P_stop/Serial_Nb_21",300,10,900,500);
    c0->SetGrid();
