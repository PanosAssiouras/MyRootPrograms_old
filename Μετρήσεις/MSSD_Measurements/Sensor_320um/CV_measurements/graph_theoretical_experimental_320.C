...
void graph_theoretical_experimental_320()
{
	gROOT->Reset();
	//diabazei ta arxeia me tis theoritikes kai peiramatikes times kai kanei grafikh parastash 
	
   std::ifstream inputFile1("Backplane.Capacitance.allRegions.320.experimental.txt");
   std::ifstream inputFile2("Capacitance.allRegions.320.theoretical.txt");
   
  vector<double_t> Cbs_exp,Cbs_theo;
   ...
   TH1F *h1exp = new TH1F("h1exp","Backplane capacitance theoretical and experimental Sensor_320",12,0,12);

         
    TH1F *h1theo = new TH1F("h1theo","Backplane capacitance theretical vs Capacitance experimental Sensor_320",12,0,12);
...
leg->AddEntry(h1exp, "Backplane experimental", "lp");
leg->AddEntry(h1theo, "Backplane theoretical", "lp");
