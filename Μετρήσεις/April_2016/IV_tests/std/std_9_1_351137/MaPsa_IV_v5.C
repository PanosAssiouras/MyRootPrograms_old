...
{   
    ...
    TCanvas *c0=new TCanvas("c0","Current vs Voltage:0 to 350:std_9_1_351137",300,10,900,500);
    c0->SetGrid();

    
    TCanvas *c1=new TCanvas("c1","Total current, std_9_1_351137 ",300,10,900,500);
    c1->SetGrid();
    
    TCanvas *c3=new TCanvas("c3","Current matrix 200V:std_9_1_351137 ",300,10,900,500);
    c3->SetGrid();
     
     TCanvas *c5=new TCanvas("c5","Current matrix 200V:std_9_1_351137",300,10,900,500);
     c5->SetGrid();

   TPad *pad = new TPad("pad","The pad with the histogram",0.05,0.05,0.95,0.45,21);
   ...
   TH2D *Hist= new TH2D("Hist","2D",48,0,48,6,0,6);
    ...
    TMultiGraph *mg = new TMultiGraph();
     mg->SetMinimum(-10.0);
     mg->SetMaximum(100.0);
     mg->SetTitle("Current vs Voltage:0 to 350:std_9_1_351137"); 

	
   TLegend *leg = new TLegend(0.90, 0.05, 0.999, 0.95);
   ...
   leg->SetTextSize(0.016);
    ...
    for (unsigned int i = 0;i < files.size();i++) {
	   ...
	   {     
		    if(markerstyle == 34) {markerstyle=20;}
            ...
            x= convert.str();
            //--------------------------
            Hist->GetXaxis()->SetBinLabel(i+1,x.c_str());
		    }
            ...
            string y;          
            ostringstream convert;   
            convert <<5-i; //7-i so 1 goes up
            y= convert.str();
            //-------------------------
            Hist->GetYaxis()->SetBinLabel(i+1,y.c_str());
		    }
		    //------------------------------------------------------------------------
   ...
   //   Hist->Fill(x,y,I);
            ...
            gr->SetTitle("Total current:std_2_15_351136");
            gr->SetMarkerStyle(3);
     	    gr->SetMarkerColor(9);
     	    gr->SetLineColor(12);
...
*/
   ...
   //  Xaxis->SetLabelOffset(999); 
     Hist->SetTitle("Current matrix 200V:std_9_1_351137");  
