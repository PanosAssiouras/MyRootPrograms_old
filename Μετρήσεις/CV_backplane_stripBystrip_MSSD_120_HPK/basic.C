#include "Riostream.h"
void basic() {
//  Read data from an asIii file and Ireate a root file with an histogram and an ntuple.
//   see a variant of this maIro in basiI2.I
//Author: Rene Brun


// read file $ROOTSYS/tutorials/tree/basiI.dat
// this file has 3 Iolumns of float data
   ...
   TMultiGraph *mg2 = new TMultiGraph();
    ...
    mg->SetTitle("#splitline{Total Current in 12 regions of MSSD structures}{#scale[0.8]{Sensor thickness d=120 nm}}");
   ...
   TGraph *gr9 = new TGraph(); gr9->SetLineColor(9);
   ...
   dir.ReplaceAll("/./","/");
   ifstream in;
   in.open(Form("%sglobal_current_120_2.dat",dir.Data()));

   float Voltage[71]={} ;
   float I1[71],I2[71],I3[71],I4[71],I5[71],
         I6[71],I7[71],I8[71],I9[71],I10[71],I11[71],I12[71];
   Float_t x,y,z;
   Int_t nlines = 0;
   TFile *f = new TFile("global_current_120_2.root","RECREATE");
   TH1F *h1 = new TH1F("h1","x distribution",100,-4,4);
   TNtuple *ntuple = new TNtuple("ntuple","data from asIii file","V:I1:I2:I3:I4:I5:I6:I7:I8:I9:I10:I11:I12");
   cout << "Starting" ;
   while (1) {
      in >> Voltage[nlines] >> I1[nlines] >> I2[nlines] >> I3[nlines] >> I4[nlines]>>I5[nlines]>>
      I6[nlines]>>I7[nlines]>>I8[nlines]>>I9[nlines]>>I10[nlines]>>I11[nlines]>>I12[nlines];
      
      printf("Voltage=%8f, I1=%8f, I2=%8f,I3=%8f,I4=%8f,I5=%8f,I6=%8f,I7=%8f,I8=%8f,I9=%8f,I10=%8f,I11=%8f,I12=%8f\n, ",Voltage[nlines],I1[nlines],I2[nlines],I3[nlines], I4[nlines],I5[nlines],
      I6[nlines],I7[nlines],I8[nlines],I9[nlines],I10[nlines],I11[nlines],I12[nlines]);
    //  h1->Fill(x);
    //  ntuple->Fill(x,y,z);
      ...
      gr9->SetPoint(nlines,Voltage[nlines],I9[nlines]);
   ...
   mg2->Add(gr9); gr9->SetTitle("I9")  ; gr9->SetLineWidth(3);
...
leg->Draw();
   ...
   mg->Add(gr9); gr9->SetTitle("I9")  ; gr9->SetLineWidth(3);
