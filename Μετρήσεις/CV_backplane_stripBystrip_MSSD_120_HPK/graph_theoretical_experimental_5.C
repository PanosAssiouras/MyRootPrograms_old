...
void graph_theoretical_experimental_5()
{
	gROOT->Reset();
   ...
   std::ifstream inputFile2("Capacitance.theoretical.pitch.70.thickness.120.txt");
   //----------------------------------------------------------------------------------------------
   //dhlwsh metablhtwn
   ...
   mg->SetTitle("#splitline{Total Capacitance theoretical and experimental vs w/p}{#scale[0.8]{Sensor thickness d=120 nm, pitch=70 um}}");    
...
//--------------------------------------------------------------------------------------------------------------
//Set points graph experimental only Regions with pitch=70
   gr2->SetPoint(0,Regions[3],Ctots_exp[3]);
     gr2->SetPoint(1,Regions[7],Ctots_exp[7]);
       gr2->SetPoint(2,Regions[11],Ctots_exp[11]);
       
   gr3->SetPoint(0,Regions2[3],Ctots_exp[3]);
     gr3->SetPoint(1,Regions2[7],Ctots_exp[7]);
       gr3->SetPoint(2,Regions2[11],Ctots_exp[11]);
       
    gr4->SetPoint(0,Regions3[3],Ctots_exp[3]);
     gr4->SetPoint(1,Regions3[7],Ctots_exp[7]);
       gr4->SetPoint(2,Regions3[11],Ctots_exp[11]);
