...
void graph_theoretical_experimental_3()
{
	gROOT->Reset();
   ...
   std::ifstream inputFile2("Capacitance.theoretical.pitch.240.thickness.120.txt");
   //----------------------------------------------------------------------------------------------
   //dhlwsh metablhtwn
   ...
   int pitch=240.0;
     ...
     gStyle->SetTitleAlign(23);
      ...
      mg->SetTitle("#splitline{Total Capacitance theoretical and experimental vs w/p}{#scale[0.8]{Sensor thickness d=120 nm , pitch=240 um}}");    
...
//-------------------------------------------------------------------------------------------------   
 ...
 //Set points graph theoritical  
  ...
  //----------------------------------------------------------------------------------------------------------------- 
  //display on terminal experimental data only Regions with pitch=240.0
         std::cout<<"points read:\n";
...
//--------------------------------------------------------------------------------------------------------------
//Set points graph experimental only Regions with pitch=240.0
   gr2->SetPoint(0,Regions[1],Ctots_exp[1]);
     gr2->SetPoint(1,Regions[5],Ctots_exp[5]);
       gr2->SetPoint(2,Regions[9],Ctots_exp[9]);
       
   gr3->SetPoint(0,Regions2[1],Ctots_exp[1]);
     gr3->SetPoint(1,Regions2[5],Ctots_exp[5]);
       gr3->SetPoint(2,Regions2[9],Ctots_exp[9]);
       
    gr4->SetPoint(0,Regions3[1],Ctots_exp[1]);
     gr4->SetPoint(1,Regions3[5],Ctots_exp[5]);
       gr4->SetPoint(2,Regions3[9],Ctots_exp[9]);
