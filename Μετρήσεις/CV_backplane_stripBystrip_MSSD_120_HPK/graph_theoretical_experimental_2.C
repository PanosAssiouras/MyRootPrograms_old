...
void graph_theoretical_experimental_2()
{
	gROOT->Reset();
   ...
   std::ifstream inputFile2("Capacitance.theoretical.pitch.80.thickness.120.txt");
   //----------------------------------------------------------------------------------------------
   //dhlwsh metablhtwn
   ...
   mg->SetTitle("#splitline{Total Capacitance theoretical and experimental vs w/p}{#scale[0.8]{Sensor thickness d=120 nm, pitch=80 um}}");    
...
//--------------------------------------------------------------------------------------------------------------
//Set points graph experimental only Regions with pitch=80 
   gr2->SetPoint(0,Regions[2],Ctots_exp[2]);
     gr2->SetPoint(1,Regions[6],Ctots_exp[6]);
       gr2->SetPoint(2,Regions[10],Ctots_exp[10]);
       
   gr3->SetPoint(0,Regions2[2],Ctots_exp[2]);
     gr3->SetPoint(1,Regions2[6],Ctots_exp[6]);
       gr3->SetPoint(2,Regions2[10],Ctots_exp[10]);
       
    gr4->SetPoint(0,Regions3[2],Ctots_exp[2]);
     gr4->SetPoint(1,Regions3[6],Ctots_exp[6]);
       gr4->SetPoint(2,Regions3[10],Ctots_exp[10]);
